...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		Setting siteName = new Setting("SITE_NAME", "Shoponge", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "Shoponge.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2021 Shoponge Ltd.", SettingCategory.GENERAL);
