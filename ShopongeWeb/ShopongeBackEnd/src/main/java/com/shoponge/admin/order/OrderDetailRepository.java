...
public interface OrderDetailRepository extends CrudRepository<OrderDetail, Integer> {
	...
	@Query("SELECT NEW com.shoponge.common.entity.order.OrderDetail(d.product.category.name, d.quantity,"
	...
	@Query("SELECT NEW com.shoponge.common.entity.order.OrderDetail(d.quantity, d.product.name,"
			+ " d.productCost, d.shippingCost, d.subtotal)"
			+ " FROM OrderDetail d WHERE d.order.orderTime BETWEEN ?1 AND ?2")
